...
plt.legend()
plt.savefig("../data/AAPL/ma_model.png")
...
print(s_data[["predicted","actual_return", "signal", "strategy_return"]])

print(f"s_return on AAPL: {s_return}", "%")
print(f"m_return on AAPL: {m_return}", "%")
